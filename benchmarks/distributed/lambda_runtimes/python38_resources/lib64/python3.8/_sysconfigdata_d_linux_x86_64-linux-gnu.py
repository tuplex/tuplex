...
build_time_vars = {'ABIFLAGS': 'd',
 ...
 'BLDSHARED': 'gcc -pthread -shared -Wl,-z,relro  -g -Wl,-z,relro  -g',
 'BUILDEXE': '',
 'BUILDPYTHON': 'python',
 'BUILD_GNU_TYPE': 'x86_64-koji-linux-gnu',
 'BYTESTR_DEPS': '\\',
 'CC': 'gcc -pthread',
 'CCSHARED': '-fPIC',
 'CFLAGS': '-Wno-unused-result -Wsign-compare -O2 -g -pipe -Wall '
           ...
           '-Wp,-D_FORTIFY_SOURCE=2 -fexceptions -fstack-protector-strong '
           '--param=ssp-buffer-size=4 -grecord-gcc-switches    -m64 '
           '-mtune=generic -D_GNU_SOURCE -fPIC -fwrapv   -O0',
 'CFLAGSFORSHARED': '-fPIC',
 'CFLAGS_ALIASING': '',
 'CONFIGFILES': 'configure configure.ac acconfig.h pyconfig.h.in '
                'Makefile.pre.in',
 'CONFIGURE_CFLAGS': '-O2 -g -pipe -Wall -Wp,-D_FORTIFY_SOURCE=2 -fexceptions '
                     '-fstack-protector-strong --param=ssp-buffer-size=4 '
                     '-grecord-gcc-switches    -m64 -mtune=generic '
                     '-D_GNU_SOURCE -fPIC -fwrapv',
 'CONFIGURE_CFLAGS_NODIST': '-O2 -g -pipe -Wall -Wp,-D_FORTIFY_SOURCE=2 '
                            '-fexceptions -fstack-protector-strong '
                            '--param=ssp-buffer-size=4 '
                            '-grecord-gcc-switches    -m64 -mtune=generic '
                            '-D_GNU_SOURCE -fPIC -fwrapv -flto '
 ...
 'CONFIGURE_CPPFLAGS': '',
 'CONFIGURE_LDFLAGS': '-Wl,-z,relro  -g',
 'CONFIGURE_LDFLAGS_NODIST': '-Wl,-z,relro  -g   -flto -fuse-linker-plugin '
                             '-ffat-lto-objects -flto-partition=none -g',
 'CONFIG_ARGS': "'--build=x86_64-koji-linux-gnu' "
                ...
                "'--with-pydebug' 'build_alias=x86_64-koji-linux-gnu' "
 ...
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/builddir/build/BUILD/Python-3.8.5/build/debug/coverage.info',
 'COVERAGE_REPORT': '/builddir/build/BUILD/Python-3.8.5/build/debug/lcov-report',
 'COVERAGE_REPORT_OPTIONS': '--no-branch-coverage --title "CPython lcov '
                            'report"',
 'CPPFLAGS': '-IObjects -IInclude -IPython -I. '
             '-I/builddir/build/BUILD/Python-3.8.5/Include',
 'CXX': 'g++ -pthread',
 ...
 'HAVE_ZLIB_COPY': 1,
 'HAVE__GETPTY': 0,
 'HOST_GNU_TYPE': 'x86_64-koji-linux-gnu',
 ...
 'LDFLAGS': '-Wl,-z,relro  -g -Wl,-z,relro  -g',
 'LDLIBRARY': 'libpython3.8d.so',
 'LDLIBRARYDIR': '',
 'LDSHARED': 'gcc -pthread -shared -Wl,-z,relro  -g -Wl,-z,relro  -g',
 'LDVERSION': '3.8d',
 'LIBC': '',
 ...
 'MAKESETUP': '/builddir/build/BUILD/Python-3.8.5/Modules/makesetup',
 ...
 'OPT': '-O2 -g -pipe -Wall -Wp,-D_FORTIFY_SOURCE=2 -fexceptions '
        '-fstack-protector-strong --param=ssp-buffer-size=4 '
 ...
 'PYTHON_HEADERS': '\\',
 'PYTHON_OBJS': '\\',
 'PY_BUILTIN_MODULE_CFLAGS': '-Wno-unused-result -Wsign-compare -O2 -g -pipe '
                             ...
                             '--param=ssp-buffer-size=4 '
                             '-grecord-gcc-switches    -m64 -mtune=generic '
                             '-D_GNU_SOURCE -fPIC -fwrapv   -O0 -O2 -g -pipe '
                             '-Wall -Wp,-D_FORTIFY_SOURCE=2 -fexceptions '
                             '-fstack-protector-strong '
                             '--param=ssp-buffer-size=4 '
                             '-grecord-gcc-switches    -m64 -mtune=generic '
                             ...
                             '--param=ssp-buffer-size=4 '
                             '-grecord-gcc-switches    -m64 -mtune=generic '
                             '-D_GNU_SOURCE -fPIC -fwrapv -O0 '
                             '-I/builddir/build/BUILD/Python-3.8.5/Include/internal '
                             '-IObjects -IInclude -IPython -I. '
                             '-I/builddir/build/BUILD/Python-3.8.5/Include '
                             '-fPIC -DPy_BUILD_CORE_BUILTIN',
 'PY_CFLAGS': '-Wno-unused-result -Wsign-compare -O2 -g -pipe -Wall '
              '-Wp,-D_FORTIFY_SOURCE=2 -fexceptions -fstack-protector-strong '
              '--param=ssp-buffer-size=4 -grecord-gcc-switches    -m64 '
              '-mtune=generic -D_GNU_SOURCE -fPIC -fwrapv -O2 -g -pipe -Wall '
              '-Wp,-D_FORTIFY_SOURCE=2 -fexceptions -fstack-protector-strong '
              ...
              '--param=ssp-buffer-size=4 -grecord-gcc-switches    -m64 '
              '-mtune=generic -D_GNU_SOURCE -fPIC -fwrapv   -O0',
 'PY_CFLAGS_NODIST': '-O2 -g -pipe -Wall -Wp,-D_FORTIFY_SOURCE=2 -fexceptions '
                     '-fstack-protector-strong --param=ssp-buffer-size=4 '
                     '-grecord-gcc-switches    -m64 -mtune=generic '
 ...
 'PY_CORE_CFLAGS': '-Wno-unused-result -Wsign-compare -O2 -g -pipe -Wall '
                   '-Wp,-D_FORTIFY_SOURCE=2 -fexceptions '
                   '-fstack-protector-strong --param=ssp-buffer-size=4 '
                   '-grecord-gcc-switches    -m64 -mtune=generic -D_GNU_SOURCE '
                   '-fPIC -fwrapv -O2 -g -pipe -Wall -Wp,-D_FORTIFY_SOURCE=2 '
                   '-fexceptions -fstack-protector-strong '
                   '--param=ssp-buffer-size=4 -grecord-gcc-switches    -m64 '
                   '-mtune=generic -D_GNU_SOURCE -fPIC -fwrapv -O2 -g -pipe '
                   '-Wall -Wp,-D_FORTIFY_SOURCE=2 -fexceptions '
                   '-fstack-protector-strong --param=ssp-buffer-size=4 '
                   '-grecord-gcc-switches    -m64 -mtune=generic -D_GNU_SOURCE '
                   '-fPIC -fwrapv   -O0 -O2 -g -pipe -Wall '
                   '-Wp,-D_FORTIFY_SOURCE=2 -fexceptions '
                   '-fstack-protector-strong --param=ssp-buffer-size=4 '
                   '-grecord-gcc-switches    -m64 -mtune=generic -D_GNU_SOURCE '
                   '-fPIC -fwrapv -flto -fuse-linker-plugin -ffat-lto-objects '
                   '-flto-partition=none -g -std=c99 -Wextra '
                   '-Wno-unused-result -Wno-unused-parameter '
                   '-Wno-missing-field-initializers '
                   '-Werror=implicit-function-declaration -O2 -g -pipe -Wall '
                   ...
                   '-I/builddir/build/BUILD/Python-3.8.5/Include/internal '
                   '-IObjects -IInclude -IPython -I. '
                   '-I/builddir/build/BUILD/Python-3.8.5/Include -fPIC '
                   '-DPy_BUILD_CORE',
 'PY_CORE_LDFLAGS': '-Wl,-z,relro  -g -Wl,-z,relro  -g -Wl,-z,relro  -g   '
                    '-flto -fuse-linker-plugin -ffat-lto-objects '
                    '-flto-partition=none -g -Wl,-z,relro  -g',
 'PY_CPPFLAGS': '-IObjects -IInclude -IPython -I. '
                '-I/builddir/build/BUILD/Python-3.8.5/Include',
 'PY_FORMAT_SIZE_T': '"z"',
 'PY_LDFLAGS': '-Wl,-z,relro  -g -Wl,-z,relro  -g',
 'PY_LDFLAGS_NODIST': '-Wl,-z,relro  -g   -flto -fuse-linker-plugin '
                      '-ffat-lto-objects -flto-partition=none -g -Wl,-z,relro  '
                      '-g',
 'PY_SSL_DEFAULT_CIPHERS': 2,
 'PY_SSL_DEFAULT_CIPHER_STRING': 0,
 'PY_STDMODULE_CFLAGS': '-Wno-unused-result -Wsign-compare -O2 -g -pipe -Wall '
                        '-Wp,-D_FORTIFY_SOURCE=2 -fexceptions '
                        '-fstack-protector-strong --param=ssp-buffer-size=4 '
                        '-grecord-gcc-switches    -m64 -mtune=generic '
                        '-D_GNU_SOURCE -fPIC -fwrapv -O2 -g -pipe -Wall '
                        ...
                        '-fstack-protector-strong --param=ssp-buffer-size=4 '
                        '-grecord-gcc-switches    -m64 -mtune=generic '
                        '-D_GNU_SOURCE -fPIC -fwrapv   -O0 -O2 -g -pipe -Wall '
                        '-Wp,-D_FORTIFY_SOURCE=2 -fexceptions '
                        '-fstack-protector-strong --param=ssp-buffer-size=4 '
                        '-grecord-gcc-switches    -m64 -mtune=generic '
                        '-D_GNU_SOURCE -fPIC -fwrapv -flto -fuse-linker-plugin '
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'LD_LIBRARY_PATH=/builddir/build/BUILD/Python-3.8.5/build/debug',
 'SCRIPTDIR': '/usr/lib64',
 'SETPGRP_HAVE_ARG': 0,
 'SGI_ABI': '@SGI_ABI@',
 'SHELL': '/bin/sh',
 ...
 'SRC_GDB_HOOKS': '/builddir/build/BUILD/Python-3.8.5/Tools/gdb/libpython.py',
 'STDC_HEADERS': 1,
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': 'LD_LIBRARY_PATH=/builddir/build/BUILD/Python-3.8.5/build/debug '
               './python',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'LD_LIBRARY_PATH=/builddir/build/BUILD/Python-3.8.5/build/debug '
               './python '
               '/builddir/build/BUILD/Python-3.8.5/Tools/scripts/run_tests.py',
 'TESTTIMEOUT': 1200,
 'TIMEMODULE_LIB': 0,
 ...
 'UPDATE_FILE': 'python3.8 '
                '/builddir/build/BUILD/Python-3.8.5/Tools/scripts/update_file.py',
 'USE_COMPUTED_GOTOS': 1,
 'VERSION': '3.8',
 'VPATH': '/builddir/build/BUILD/Python-3.8.5',
 'WINDOW_HAS_FLAGS': 1,
 ...
 'abs_builddir': '/builddir/build/BUILD/Python-3.8.5/build/debug',
 'abs_srcdir': '/builddir/build/BUILD/Python-3.8.5',
 'datarootdir': '/usr/share',
 'exec_prefix': '/usr',
 'prefix': '/usr',
 'srcdir': '/builddir/build/BUILD/Python-3.8.5'}
