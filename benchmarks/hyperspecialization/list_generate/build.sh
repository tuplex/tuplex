...
g++ -std=c++17 -msse4.2 -mcx16 -Wall -Wextra -O3 -march=native -DNDEBUG -o tuplex_int_nopydict count_unique_bench.cc -DTUPLEX_INT -I/usr/include/python3.8 -lpython3.8 -ldl
