...
RES_ROOT_DIR=results-agg-experiment-stlmap
NUM_RUNS="${NUM_RUNS:-11}"
SO_SPECIALIZED=agg_weather_specialized-stlmap.so
SO_GENERAL=agg_weather_general-stlmap.so
...
clang++ -shared -fPIC -O3 -march=haswell -msse4.2 -mcx16 -DNDEBUG -o $SO_GENERAL src/agg_query_stlmap/agg_general.cc
clang++ -shared -fPIC -O3 -march=haswell -msse4.2 -mcx16 -DNDEBUG -o $SO_SPECIALIZED src/agg_query_stlmap/agg_specialized.cc
