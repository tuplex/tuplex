...
if __name__ == '__main__':
    ...
    parser.add_argument('--executor-memory', default='15G', help='how much memory each thread gets')
    parser.add_argument('--driver-memory', default='15G', help='how much memory each thread gets')
