...
if __name__ == '__main__':
    ...
    parser.add_argument('--executor-memory', default='1G', help='how much memory each thread gets')
    parser.add_argument('--executor-count', default=4, help='how many worker threads')
