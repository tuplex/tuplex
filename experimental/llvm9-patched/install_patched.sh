...
echo ">> target dir will be ${PREFIX}/llvm-9.0.patched"
...
#         -DCMAKE_INSTALL_PREFIX=/opt/llvm-9.0.patched ../llvm-9.0.1.src \
#         && make -j "$(nproc)" && make install
#cd ${PREFIX}/llvm-9.0.patched/bin && ln -s clang++ clang++-9.0