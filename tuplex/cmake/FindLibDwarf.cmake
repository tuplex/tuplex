...
#  LIBDWARF_INCLUDE_DIR - the libdwarf include directory
...
if (LIBDWARF_LIBRARIES AND LIBDWARF_INCLUDE_DIR)
    set (LibDwarf_FIND_QUIETLY TRUE)
endif (LIBDWARF_LIBRARIES AND LIBDWARF_INCLUDE_DIR)
...
if (DWARF_INCLUDE_DIR)
    set (LIBDWARF_INCLUDE_DIR  ${DWARF_INCLUDE_DIR})
endif ()
...
if (LIBDWARF_LIBRARIES AND LIBDWARF_INCLUDE_DIR)
    set(CMAKE_REQUIRED_INCLUDES ${LIBDWARF_INCLUDE_DIR})
