...
// and lastid hold the "return value" of the lastly evaluated "visit" function
    ...
    std::string GraphVizVisitor::typeStr(ASTNode *node) {
        if(!_showTypes)
            return "";
    ...
    void GraphVizVisitor::visit(NNumber* number) {
    ...
    void GraphVizVisitor::visit(NIdentifier *identifier) {
    ...
    void GraphVizVisitor::visit(NBoolean *boolean) {
        int iParent = getParent();
    ...
    void GraphVizVisitor::visit(NEllipsis *ellipsis) {
        int iParent = getParent();
    ...
    void GraphVizVisitor::visit(NNone* none) {
        int iParent = getParent();
    ...
    void GraphVizVisitor::visit(NBreak* node) {
        int iParent = getParent();
    ...
    void GraphVizVisitor::visit(NContinue* node) {
        int iParent = getParent();
    ...
    void GraphVizVisitor::visit(NString *string) {
        int iParent = getParent();
    ...
    void GraphVizVisitor::visit(NBinaryOp *binop) {
    ...
    void GraphVizVisitor::visit(NUnaryOp *unop) {
    ...
    void GraphVizVisitor::visit(NSuite *suite) {
    ...
    void GraphVizVisitor::visit(NModule *module) {
    ...
    void GraphVizVisitor::visit(NParameter *param) {
    ...
    void GraphVizVisitor::visit(NParameterList *pl) {
    ...
    void GraphVizVisitor::visit(NLambda *lambda) {
    ...
    void GraphVizVisitor::visit(NAwait *await) {
    ...
    void GraphVizVisitor::visit(NStarExpression *se) {
    ...
    void GraphVizVisitor::visit(NCompare *cmp) {
    ...
    void GraphVizVisitor::visit(NIfElse *ifelse) {
        std::string html = "<TABLE BORDER=\"0\" CELLBORDER=\"1\" CELLSPACING=\"0\">\n"
                           "   <TR>\n"
    ...
    void GraphVizVisitor::visit(NFunction *func) {
        std::string html = "<TABLE BORDER=\"0\" CELLBORDER=\"1\" CELLSPACING=\"0\">\n"
                           "   <TR>\n"
    ...
    void GraphVizVisitor::visit(NTuple *tuple) {
    ...
    void GraphVizVisitor::visit(NList *list) {
    ...
    void GraphVizVisitor::visit(NDictionary *dict) {
    ...
    void GraphVizVisitor::visit(NReturn* ret) {
    ...
    std::string GraphVizVisitor::escapeHTML(const std::string &s) {
    ...
    void GraphVizVisitor::visit(NSubscription *sub) {
        assert(sub->_value);
    ...
    void GraphVizVisitor::visit(NAssign* as) {
#warning "change this later when adding full support for assignment statement"
    ...
    void GraphVizVisitor::visit(NCall* call) {
#warning "order of args displayed is not correct..."
    ...
    void GraphVizVisitor::visit(NAttribute* attr) {
    ...
    void GraphVizVisitor::visit(NSlice *slicing) {
    ...
    void GraphVizVisitor::visit(NSliceItem *slicingItem) {
        std::string html = "<TABLE BORDER=\"0\" CELLBORDER=\"1\" CELLSPACING=\"0\">\n"
                           "   <TR>\n"
    ...
    void GraphVizVisitor::visit(NRange* range) {
#warning "order of args displayed is not correct..."
    ...
    void GraphVizVisitor::visit(NComprehension *comprehension) {
        std::string html = "<TABLE BORDER=\"0\" CELLBORDER=\"1\" CELLSPACING=\"0\">\n"
                           "   <TR>\n"
...
//        _builder->addEdge(iParent, id);
    ...
    void GraphVizVisitor::visit(NListComprehension *listComprehension) {
        std::string html = "<TABLE BORDER=\"0\" CELLBORDER=\"1\" CELLSPACING=\"0\">\n"
                           "   <TR>\n"
    ...
    void GraphVizVisitor::visit(NAssert *as) {
    ...
    void GraphVizVisitor::visit(NRaise *rs) {
    ...
    void GraphVizVisitor::visit(NWhile *node) {
        std::string html = "<TABLE BORDER=\"0\" CELLBORDER=\"1\" CELLSPACING=\"0\">\n"
                           "   <TR>\n"
                           "    <TD BGCOLOR=\"#48B887\" COLSPAN=\"3\">parameter";
        html += "</TD>\n"
    ...
    void GraphVizVisitor::visit(NFor *node) {
        std::string html = "<TABLE BORDER=\"0\" CELLBORDER=\"1\" CELLSPACING=\"0\">\n"
                           "   <TR>\n"
