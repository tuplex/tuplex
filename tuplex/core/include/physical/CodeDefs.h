...
namespace tuplex {
    ...
    namespace codegen {
        ...
        // prototype of the function generated by the builder when filters and input exceptions are present
        // parameters are userData, block, blocksize, array of exception ptrs, size of each exception ptr, normalrowsout, badrowsout, lastRow
