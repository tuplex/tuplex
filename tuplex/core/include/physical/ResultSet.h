...
namespace tuplex {
    ...
    public:
        ...
        ResultSet(const Schema& _schema,
                  ...
                  const std::unordered_map<std::string, std::tuple<size_t, size_t, size_t>>& partitionToExceptionsMap=std::unordered_map<std::string, std::tuple<size_t, size_t, size_t>>(),
