...
//
//            auto cond_is_badparse = builder.CreateICmpEQ(ecCode, env.i64Const(ecToI64(ExceptionCode::BADPARSE_STRING_INPUT)));
//            builder.CreateCondBr(cond_is_badparse, bbStringFieldDecode, bbCommonCaseDecode);
//
//
//            // Note: this function here is an old design -> it basically forces checks etc. onto the slowpath.
//            // prob. better, but more complex.
//
//            // three decode options
//            {
//                // A.) decode string fields & match with exception case type
...
//            }
//
//            // B.) decode common/exception case type
//            {
...
//// old version: Assumes normal-case input format for exceptions.
//        llvm::Function* createProcessExceptionRowWrapper(PipelineBuilder& pip,
//                                                         const std::string& name, const python::Type& normalCaseType,
//                                                         const std::map<int, int>& normalToGeneralMapping,
//                                                         const std::vector<std::string>& null_values,
