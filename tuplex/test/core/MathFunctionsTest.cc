...
//     EXPECT_EQ(v4.size(), 3);
//     EXPECT_EQ(v4[0].getBool(0), true);
//     EXPECT_EQ(v4[1].getBool(0), false);
//     EXPECT_EQ(v4[2].getBool(0), true);
