//
// Created by leonhard on 9/21/22.
//
//===- DebugTypeFinder.cpp - Implement the DebugTypeFinder class --------------------===//
//
...
//===----------------------------------------------------------------------===//
//
// This file implements the DebugTypeFinder class for the IR library.
//
//===----------------------------------------------------------------------===//
...
void DebugTypeFinder::run(const Module &M, bool onlyNamed) {
    OnlyNamed = onlyNamed;
...
void DebugTypeFinder::incorporateType(Type *Ty) {
...
void DebugTypeFinder::incorporateValue(const Value *V) {
...
void DebugTypeFinder::incorporateMDNode(const MDNode *V) {
    // Already visited?
