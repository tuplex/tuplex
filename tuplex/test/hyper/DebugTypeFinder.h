...
#ifndef TUPLEX_DEBUGDebugTypeFinder_H
#define TUPLEX_DEBUGDebugTypeFinder_H


//===- llvm/IR/DebugTypeFinder.h - Class to find used struct types ---*- C++ -*-===//
//
...
//===----------------------------------------------------------------------===//
//
// This file contains the declaration of the DebugTypeFinder class.
//
//===----------------------------------------------------------------------===//
...
/// DebugTypeFinder - Walk over a module, identifying all of the types that are
/// used by the module.
    class DebugTypeFinder {
...
#endif //TUPLEX_DEBUGDebugTypeFinder_H
