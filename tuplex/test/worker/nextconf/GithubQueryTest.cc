...
//                              "number_of_commits", "forkee", "forkee_url", "watchers"})
    ...
    TEST_F(GithubQuery, ExtractWatchersTest) {
        ...
        std::vector<std::string> input_columns({"type", "public", "actor", "created_at", "payload", "id", "repo", "org", "year", "repo_id", "commits", "number_of_commits", "forkee"});
